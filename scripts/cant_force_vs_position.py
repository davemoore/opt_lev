...
idx_to_plot = [104,105,106,107,108] ## indices from dir file below to use
...
#### COMPARING TO COMSOL DATA ####

#comsoldata_4_3V = np.loadtxt('/home/charles/electrostatic_force_vs_pos_4_3V.txt', delimiter=',')
#comsoldata_10V = np.loadtxt('/home/charles/electrostatic_force_vs_pos_10V.txt', delimiter=',')

#force_4_3 = golay(comsoldata_4_3V[:,1], 91, 3)
#force_10 = golay(comsoldata_10V[:,1], 91, 3)

#plt.plot(comsoldata_4_3V[:,0] * 1e6, force_4_3 + 2.25e-14, linewidth=2, color='g')
#plt.plot(comsoldata_10V[:,0] * 1e6, force_10 + 2.25e-14, linewidth=2, color='m')
#plt.xlim(28,200)
#plt.ylim(0, 8e-14)
...
#plt.figure()
#plt.plot(comsoldata_4_3V[:,0] * 1e6, force_4_3 + 2.25e-14, linewidth=2, color='g')
#plt.plot(comsoldata_4_3V[:,0] * 1e6, comsoldata_4_3V[:,1] + 2.25e-14, linewidth=2, color='g')
#plt.plot(comsoldata_10V[:,0] * 1e6, force_10 + 2.25e-14, linewidth=2, color='m')
#plt.plot(comsoldata_10V[:,0] * 1e6, comsoldata_10V[:,1] + 2.25e-14, linewidth=2, color='m')
#plt.xlim(28,82)
#plt.ylim(0, 8e-14)
