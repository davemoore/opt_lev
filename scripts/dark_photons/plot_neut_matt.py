...
def make_pos_plot(dq, N, Z, linecol='k', fillcol='k', do_fill = True, linesty="-", lw=1.5):
    ...
    min_val, max_val = 1e-29, 1e-19 #1e-28, 1e-18
    min_exp, max_exp = -29, -17
...
plt.text(2e-29, 2.5e-21, "Bressi et al. (2011)", color=ec, fontsize=13, rotation=0, va='bottom', ha='left')
plt.text(2.5e-21, 0.8e-19, "Baumann et al. (1988)", color=ec, fontsize=12, rotation=90, va='top', ha='left')
plt.text(2e-29, 3e-24, "This proposal", color='k', fontsize=13, rotation=0, va='bottom', ha='left')
