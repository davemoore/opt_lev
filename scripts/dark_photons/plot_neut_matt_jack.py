...
def make_pos_plot(dq, N, Z, linecol='k', fillcol='k', do_fill = True, linesty="-", lw=1.5):
    ...
    min_val, max_val = 1e-24, 5e-20 #1e-28, 1e-18
    min_exp, max_exp = -25, -17
...
prev_dat = [ #[2.6e-21, 2, 2],
             [2.2e-22/2, 30.09, 30.0, True, prev_col,'-','k'],  ###  Update these to more reasonable 
...
plt.text(2e-24, 2.5e-21, "Bressi et al. (2011)", color=ec, fontsize=12, rotation=0, va='bottom', ha='left')
