...
def proc_dir(d):
    ...
    dir_obj.load_H("./trans_funcs/Hout_20160712.p")
...
thermal_cal_file_path = '/data/20160711/bead2/1_5mbar_zcool_final.h5'
...
for i, obj in enumerate(dir_objs):
    ...
    obj.get_avg_force_v_pos(cant_axis = cant_axis, bin_size = 4)

    obj.get_avg_diag_force_v_pos(cant_axis = cant_axis, bin_size = 4)
